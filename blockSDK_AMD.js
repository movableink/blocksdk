define(
  function() {
    return function BlockSDK(whitelistOverride, sslOverride) {      
      ...
      this.showConfigs = function() {
        alert(whitelistOverride);
      };
    };
})

// Move this file to the ember app's vendor folder and add the following to the 'ember-cli-build.js' file

// app.import('vendor/sfmc/blockSDK.js', {
//   using: [
//     { transformation: 'amd', as: 'blockSDK' }
//   ]
// });